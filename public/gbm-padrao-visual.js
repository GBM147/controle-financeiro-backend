(function () {
    ...
    // O Dashboard possui layout próprio e não deve ser convertido para o padrão
    ...
    function injetarEstilos() {
        ...
        style.textContent = `
            body.gbm-interna .gbm-padrao-topbar {
                position: sticky;
                top: 0;
                z-index: 10000;
                display: flex;
            ...
            body.gbm-interna .gbm-padrao-brand {
                display: inline-flex;
                align-items: center;
                gap: 15px;
                min-width: 0;
            ...
            body.gbm-interna .gbm-padrao-brand img {
                width: auto;
                height: 70px;
                flex: 0 0 auto;
                border-radius: 10px;
            ...
            body.gbm-interna .gbm-padrao-brand span {
                overflow: hidden;
                max-width: 55vw;
                ...
                white-space: nowrap;
                animation: gbm-padrao-shine 4s linear infinite;
            }
            @keyframes gbm-padrao-shine {
                from { background-position: 0 center; }
                to { background-position: 200% center; }
            }
            body.gbm-interna .gbm-padrao-top-actions {
                display: flex;
                gap: 9px;
                align-items: center;
                flex-wrap: wrap;
            ...
            body.gbm-interna .gbm-padrao-voltar {
                display: inline-flex;
                align-items: center;
            ...
            body.gbm-interna .gbm-padrao-voltar:hover {
                transform: translateY(-1px);
                border-color: rgba(85,167,255,.58);
                box-shadow: 0 8px 22px rgba(0,0,0,.3);
            }
            body.gbm-interna .gbm-padrao-atalho {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-height: 40px;
                padding: 8px 12px;
                border: 1px solid rgba(85,167,255,.25);
                border-radius: 10px;
            ...
            body.gbm-interna .gbm-padrao-atalho:hover {
                transform: translateY(-1px);
                border-color: rgba(85,167,255,.58);
                background: rgba(85,167,255,.13);
            }
            @media (max-width: 760px) {
                body.gbm-interna .gbm-padrao-topbar { min-height: 58px; padding: 0 12px; }
                body.gbm-interna .gbm-padrao-brand { gap: 8px; }
                body.gbm-interna .gbm-padrao-brand img { height: 58px; }
                body.gbm-interna .gbm-padrao-brand span { max-width: 42vw; font-size: 1rem; letter-spacing: 1.2px; }
                body.gbm-interna .gbm-padrao-top-actions { flex-wrap: nowrap; }
                body.gbm-interna .gbm-padrao-voltar,
                body.gbm-interna .gbm-padrao-atalho { min-height: 34px; padding: 6px 9px; font-size: .72rem; }
            }
            @media (max-width: 430px) {
                body.gbm-interna .gbm-padrao-brand span { max-width: 88px; }
                body.gbm-interna .gbm-padrao-atalho { display: none; }
            }
        `;
    ...
    function criarCabecalho() {
        const existente = document.querySelector('body.gbm-interna > .topbar');
        if (existente) return;
