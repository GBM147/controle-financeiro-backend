(function () {
    ...
    const rotas = {
        visao:'dashboard.html', contas:'contas.html', importacoes:'importacoes.html',
        calendario:'calendario.html', limites:'limite-gastos.html', metas:'metas.html',
        relatorio:'relatorio.html', comparativo:'comparativo.html', notificacoes:'notificacoes.html',
        configuracoes:'configuracoes.html', perfil:'perfil.html'
    };
    ...
    const css = `
        :root {
            --gbm-green:#26874E;
            --gbm-blue:#55a7ff;
            --gbm-border:rgba(255,255,255,.13);
        }

        /* Faixa do menu alinhada ao cabeçalho do Dashboard, com o mesmo gradiente animado da marca. */
        ...
        body.gbm-interna .topbar::before {
            ...
            border-bottom:1px solid rgba(95,255,168,.20);
        }
        ...
        /* O menu fica dentro da faixa, imediatamente ao lado do Voltar. */
        .gbm-global-menu-button {
            ...
            height:40px;
            flex:0 0 40px;
            border:1px solid rgba(95,255,168,.32);
            border-radius:10px;
            background:rgba(11,22,39,.78);
        ...
        .gbm-global-menu-button:hover {
            ...
            border-color:rgba(95,255,168,.65);
        ...
        .gbm-global-menu-button span:after {
            ...
            height:2px;
            border-radius:2px;
            background:linear-gradient(90deg,#2E8B57,#5fffa8,#3d28ff,#655aff);
            content:"";
        }
        .gbm-global-menu-button span:before { transform:translateY(-6px); }
        .gbm-global-menu-button span:after { transform:translateY(4px); }

        /* Garante que Voltar + menu permaneçam lado a lado sem sobreposição. */
        ...
        .gbm-global-menu-overlay.aberto { opacity:1; visibility:visible; }
        ...
        .gbm-global-menu {
            ...
            background:linear-gradient(180deg,rgba(11,22,39,.99),rgba(7,17,31,.99));
            border-left:1px solid rgba(95,255,168,.2);
            box-shadow:-18px 0 50px rgba(0,0,0,.48);
            transform:translateX(100%);
            transition:transform .23s ease;
            overflow:auto;
        }
        .gbm-global-menu.aberto { transform:translateX(0); }
        ...
        .gbm-global-menu-brand strong {
            font:700 22px Rajdhani,Inter,sans-serif;
        ...
        @keyframes gbmMenuShine { to { background-position:200% center; } }
        ...
        .gbm-global-menu-body { padding:10px; overflow:auto; }
        ...
        .gbm-global-menu-link:hover { background:rgba(255,255,255,.055); color:#fff; }
        .gbm-global-menu-link.ativo {
            background:rgba(38,135,78,.16);
            border-left-color:var(--gbm-green);
        }
        .gbm-global-menu-icon {
            width:22px;
            text-align:center;
            color:#a8b7ca;
            font-size:1rem;
        }
        .gbm-global-menu-link.ativo .gbm-global-menu-icon { color:#6ff5a8; }
        .gbm-global-menu-separador {
            height:1px;
        ...
        .gbm-global-menu-sair { color:#ff9aa4!important; }
    ...
    /* Insere o botão no mesmo grupo do Voltar; nunca fica flutuando sobre ele. */
    ...
    menu.innerHTML = `
        ...
        <div class="gbm-global-menu-body">
            <div><div class="gbm-global-menu-title">Resumo</div>
            ...
            <div><div class="gbm-global-menu-title">Movimentações</div>
            ...
            <div><div class="gbm-global-menu-title">Planejamento</div>
            ...
            <div><div class="gbm-global-menu-title">Análises</div>
            ...
            <div class="gbm-global-menu-separador"></div>
            <div><div class="gbm-global-menu-title">Conta</div>
        ...
        <div class="gbm-global-menu-footer">
            <button class="gbm-global-menu-link gbm-global-menu-sair" id="gbm-global-menu-sair" type="button">
                <span class="gbm-global-menu-icon">←</span><span>Sair</span>
            </button>
        </div>`;
    ...
    menu.querySelector('#gbm-global-menu-sair').addEventListener('click', async () => {
        if (typeof encerrarSessao === 'function') await encerrarSessao();
        else {
